...
export const siteSettings = {
	...
	author: {
		name: "Kiaasa",
		websiteUrl: "https://kiaasa.com",
		address: "",
	},
	logo: {
		url: "/assets/images/logo-kiaasa.png",
		alt: "Kiaasa",
		href: "/",
		width: 95,
		height: 30,
	...
	site_header: {
		menu: [
			...
			// 				{
			// 					id: 1,
			// 					path: "/search?q=kurta-set",
			// 					label: "menu-kurta-set",
			// 					columnItemItems: [
			// 						// {
			// 						// 	id: 1,
			// 						// 	path: "/search?q=a-line",
			// 						// 	label: "menu-a-line",
			// 						// },
			// 						// {
			// 						// 	id: 2,
			// 						// 	path: "/search?q=front-open",
			// 						// 	label: "menu-front-open",
			// 						// },
			// 						// {
			// 						// 	id: 3,
			// 						// 	path: "/search?q=kalidar",
			// 						// 	label: "menu-kalidar",
			// 						// },
			// 						// {
			// 						// 	id: 4,
