...
export const homeSixHeroSlider = [
	{
		...
		image: {
			mobile: {
				url: "/assets/images/hero/banner-4-mob.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
				url: "/assets/images/hero/banner-5-mob.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
				url: "/assets/images/hero/banner-6-mob.jpg",
				width: 690,
				height: 480,
			},
			desktop: {
...
export const saleBannerGrid = [
	{
		...
		image: {
			mobile: {
				url: "/assets/images/banner/grid/banner-4-mob.jpg",
				width: 690,
				height: 360,
			},
			desktop: {
	...
	},
	{
		...
		image: {
			mobile: {
				url: "/assets/images/banner/grid/banner-5-mob.jpg",
				width: 690,
				height: 360,
			},
			desktop: {
